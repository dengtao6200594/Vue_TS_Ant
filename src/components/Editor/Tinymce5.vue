<template>
	<div class="tinymce_editor">
		<Editor v-model="myValue" :init="init" :disabled="disabled"></Editor>
	</div>
</template>

<script>
// 参考链接https://www.cnblogs.com/zhongchao666/p/11142537.html
// 引入组件
...
export default {
	...
	props: {
		...
		plugins: {
			type: [String, Array],
			default: 'link lists emoticons image code table wordcount media preview fullscreen help hr'
		},
		toolbar: {
			type: [String, Array],
			default:
				...
				'bold italic fontsizeselect underline strikethrough indent forecolor  backcolor link bullist alignleft emoticons image media table hr undo redo fullscreen '
		}
	},
	data() {
		return {
			init: {
				...
				emoticons_database_url: '/static/emoji.js', // 表情插入
